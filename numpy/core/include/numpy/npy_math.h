...
NPY_INPLACE double npy_cart2pol(double x, double y, double rad, double *rho, double *phi);
...
NPY_INPLACE float npy_cart2polf(float x, float y, float *rho, float *phi);
...
NPY_INPLACE npy_longdouble npy_cart2poll(npy_longdouble x, npy_longdouble y, npy_longdouble *rho, npy_longdouble *phi);
